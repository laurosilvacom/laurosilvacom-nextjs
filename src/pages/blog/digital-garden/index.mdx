...
export const meta = {
  ...
  image,
  discussion: `A digital garden is a digital space full of interconnected ideas and information that you collect, curate, tend to, and learn from over time. Blog post by @laurosilvacom`,
}
...
I'm treating my blog as a [digital garden](https://joelhooks.com/digital-garden). This means more incomplete posts at initial publish. It will focus on **JavaScript** and **React**. I'll also be publishing cheatsheet, similar to [React+TypeScript Cheatsheets](https://github.com/typescript-cheatsheets/react-typescript-cheatsheet-es).
...
I've also started a newsletter. I am personally not a big fan of emails so I promise to only send emails when I have exciting things to share with you.
